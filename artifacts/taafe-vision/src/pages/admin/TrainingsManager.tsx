...
import { Article, insertArticleSchema } from "@/lib/types";
  ...
  return (
    <Dashboard>
      <div className="flex justify-between items-center mb-8">
        <h1 className="text-3xl font-display font-bold text-primary">Gestion des Formations</h1>
        <Dialog open={open} onOpenChange={(val) => {
          ...
          <DialogContent>
            <DialogHeader>
              <DialogTitle>{editingArticle ? "Modifier la Formation" : "Publier une Formation"}</DialogTitle>
            </DialogHeader>
            <Form {...form}>
